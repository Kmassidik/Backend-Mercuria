...
// CreateP2PTransfer executes a simple peer-to-peer transfer
// NOTE: This is the most common transaction type - atomic wallet-to-wallet transfer
...
// CreateBatchTransfer executes multiple transfers atomically
// NOTE: All transfers succeed or all fail (atomicity via DB transaction)
...
// executeScheduledTransfer executes a single scheduled transfer
...
// getWallet retrieves wallet without locking
